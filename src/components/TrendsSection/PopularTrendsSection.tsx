...
function PopularTrendsSection() {
    return (
        <section className='max-w-[26rem] w-1/3 max-h-screen min-h-screen p-1 m-1 shrink hidden md:flex justify-start items-start flex-col flex-nowrap overflow-y-scroll'>
            <TwitterSearcher />
