...
function MenuOption({ href = "#", name, icon, onClick, active }: Props) {
    ...
    return (
        <Link
            href={href}
            className={`p-3.5 pl-3 ${windowWidth > 1024 || responsiveMenu && `ml-1`} rounded-full flex justify-start items-center flex-nowrap flex-row hover:bg-black/20 dark:hover:bg-white/20`}
            onClick={onClick}
        >
